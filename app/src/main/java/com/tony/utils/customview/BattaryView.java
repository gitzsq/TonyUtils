...
public class BattaryView extends View {
        ...
        for (int i = 0; i < typedArray.length(); i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.BattaryView_color:
                    color = typedArray.getColor(attr, Color.GREEN);
                    break;
            }
        }
        mPaint = new Paint();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(rectF.left + w1, rectF.top+7f, rectF.right - w1, getPaddingTop() + h1 + h1 / 10, mPaint);
        canvas.restore();
